 ...
 *
 * Manages OAuth authentication and workspace details.
...
export interface SlackWorkspaceConnection {
  ...
  /** OAuth Access Token (stored in VSCode Secret Storage only) */
  accessToken: string;

  /** OAuth token scopes (e.g., ['chat:write', 'files:write']) */
  tokenScope: string[];
