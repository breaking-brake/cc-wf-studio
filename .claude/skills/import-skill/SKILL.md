---
name: import-skill
description: Use when the user wants to convert an existing Agent Skill (`SKILL.md`) into an editable CC Workflow Studio workflow. This skill reads a procedural `SKILL.md`, maps its steps and logic to workflow nodes, and renders the visual workflow on the canvas, optionally generating a guided tour. Only works for procedural skills.
---

Convert a published Agent Skill (`SKILL.md`) into a visual, editable workflow on the CC Workflow Studio canvas.
