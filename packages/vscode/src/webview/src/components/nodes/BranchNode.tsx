/**
 * Claude Code Workflow Studio - Branch Node Component
 *
 ...
 */
export const BranchNodeComponent: React.FC<NodeProps<BranchNodeData>> = React.memo(
  ({ id, data, selected }) => {
    ...
    const nodeTitle = data.branchType === 'conditional' ? 'Conditional Branch' : 'Switch Branch';
    ...
    return (
      ...
      >
        ...
        >
          {data.branchType === 'conditional' ? '2-way' : 'Multi-way'}
        </div>
