...
export const koWebviewTranslations: WebviewTranslationKeys = {
  ...
  'overview.zoomIn': '확대',
  'overview.zoomOut': '축소',
  'overview.fitView': '전체 보기',
  'overview.followActive.on': '활성 노드 따라가기: 켬',
  'overview.followActive.off': '활성 노드 따라가기: 끔',
  'overview.layout.td': '레이아웃: 위에서 아래로 (클릭하면 왼쪽에서 오른쪽으로 전환)',
  'overview.layout.lr': '레이아웃: 왼쪽에서 오른쪽으로 (클릭하면 위에서 아래로 전환)',
  'overview.resizePanels': '뷰 패널 크기 조절',
  'overview.editNodeLink': '편집 모드로 전환하고 이 노드로 이동',
  ...
  'workflowTour.title': '워크플로 투어',
  'workflowTour.start': '워크플로 투어 시작',
  'workflowTour.start.tooltip': '워크플로 투어 시작 ({count}단계)',
  'workflowTour.generate': '워크플로 투어 생성',
  'workflowTour.generate.tooltip': '워크플로 투어 생성',
  'workflowTour.noTour': '이 워크플로에는 가이드 투어가 없습니다.',
  'workflowTour.noTourLabel': '워크플로 투어 없음',
  'workflowTour.prev': '이전',
  'workflowTour.end': '워크플로 투어 종료',
  'workflowTour.regenerate': '재생성',
  'workflowTour.regenerate.tooltip': 'AI 에이전트로 이 투어를 재생성',
  'workflowTour.regenerate.aria': '워크플로 투어 재생성',
  'workflowTour.popover.agent': '에이전트',
  'workflowTour.popover.emptyHeading': '아직 워크플로 투어가 없습니다',
  'workflowTour.popover.emptyDescription': 'AI 에이전트로 이 워크플로의 단계별 투어를 생성합니다.',
  'workflowTour.popover.generating': '생성 중…',
  'workflowTour.popover.regenerateHeading': '워크플로 투어 재생성',
  'workflowTour.popover.regenerateDescription': '현재 투어를 새로 생성한 투어로 교체합니다.',
  'workflowTour.popover.regenerateButton': '투어 재생성',
  ...
  'contextMenu.groupSelection': '그룹화',
  ...
  'shortcuts.cut': '선택 항목 잘라내기',
  'shortcuts.paste': '붙여넣기',
  'shortcuts.duplicate': '선택 항목 복제',
  'shortcuts.group': '선택 항목 그룹화',
  'shortcuts.ungroup': '선택한 그룹 해제',
  'shortcuts.nudge': '선택한 노드 이동',
  'shortcuts.nudgeLarge': '선택한 노드 크게 이동',
  ...
  'shortcuts.toggleInteraction': '이동/영역 선택 임시 전환',
  'shortcuts.gesture.arrowKeys': '방향키',
  'shortcuts.gesture.rightClick': '오른쪽 클릭',
  'shortcuts.gesture.dragToCanvas': '엣지를 캔버스로 드래그',
  'shortcuts.gesture.drag': '드래그',
  ...
  'askUserQuestion.field.options': '옵션 ({count}/4)',
  'askUserQuestion.field.options.item': '옵션 {number}',
  'askUserQuestion.field.options.add': '+ 옵션 추가',
  'branch.field.branchType': '분기 유형',
  'branch.field.branchType.option.conditional': '조건부 (2방향)',
  'branch.field.branchType.option.switch': '스위치 (다방향)',
  'branch.field.branches': '분기 ({count})',
  'branch.field.branches.item': '분기 {number}',
  'branch.field.branches.add': '+ 분기 추가',
  'ifElse.field.evaluationTarget': '평가 대상',
  'ifElse.field.evaluationTarget.placeholder': '예: 이전 단계의 실행 결과',
  'ifElse.field.evaluationTarget.help': '분기 조건에서 평가할 대상을 자연어로 설명',
  'ifElse.field.branches': '분기 ({count})',
  'ifElse.field.branches.item': '분기 {number}',
  'switch.field.evaluationTarget': '평가 대상',
  'switch.field.evaluationTarget.placeholder': '예: 이전 단계의 실행 결과',
  'switch.field.evaluationTarget.help': '분기 조건에서 평가할 대상을 자연어로 설명',
  'switch.field.branches': '분기 ({count})',
  'switch.field.branches.item': '분기 {number}',
  'switch.field.branches.add': '+ 분기 추가',
  ...
  'subAgent.field.agentType': '에이전트 유형',
  'subAgent.field.model': '모델',
  'subAgent.field.tools': '도구 (쉼표로 구분)',
  'subAgent.field.memory': '메모리',
  'subAgent.field.color': '색상',
  'subAgent.field.builtInType': '빌트인 유형',
  ...
  'claudeApi.title.apiTest': 'API 테스트',
  'claudeApi.title.apiKeyRequired': 'API 키가 필요합니다',
  'claudeApi.checkingApiKey': 'API 키 확인 중...',
  'claudeApi.enterApiKeyIntro':
    'Anthropic API 키를 입력하면 Skill을 배포하고 관리할 수 있습니다. 키는 VS Code의 시크릿 저장소에 안전하게 보관됩니다. API 키는',
  'claudeApi.enterApiKeyIntro.linkLabel': '여기',
  'claudeApi.enterApiKeyIntro.after': '에서 만들 수 있습니다.',
  'claudeApi.apiKeyLabel': 'API 키',
  'claudeApi.apiKeyInvalidPrefix': 'API 키는 "sk-ant-"로 시작해야 합니다',
  'claudeApi.apiKeySaveFailed': 'API 키 저장에 실패했습니다',
  'claudeApi.deleteApiKey': 'API 키 삭제',
  'claudeApi.deleteApiKeyConfirm': 'API 키를 삭제하시겠습니까? 계속하려면 새 키를 입력해야 합니다.',
  'claudeApi.apiKeyDeleted': 'API 키가 삭제되었습니다.',
  'claudeApi.saveAndContinue': '저장하고 계속',
  'claudeApi.loadingSkills': 'Skill 불러오는 중...',
  'claudeApi.loadSkillsFailed': 'Skill을 불러오지 못했습니다',
  'claudeApi.uploadedSkills': '업로드된 Skill',
  'claudeApi.noSkillsFound': '커스텀 Skill이 없습니다. 첫 워크플로우를 업로드해 보세요!',
  'claudeApi.delete': '삭제',
  'claudeApi.changeApiKey': 'API 키 변경',
  'claudeApi.uploadNew': '새로 업로드',
  'claudeApi.workflowToUpload': '업로드할 워크플로우:',
  'claudeApi.untitled': '제목 없음',
  'claudeApi.mcpNodesWarning.title': '이 워크플로우에는 MCP Tool 노드가 포함되어 있습니다',
  'claudeApi.mcpNodesWarning.body':
    'Claude API는 원격 HTTP MCP 서버(type: url)만 지원합니다. 로컬 stdio 서버는 사용할 수 없습니다. 업로드 후 Sample Code / Test 화면에서 서버 URL을 설정해야 합니다.',
  'claudeApi.dependentSkills.title': '이 워크플로우는 다른 Skill에 의존합니다',
  'claudeApi.dependentSkills.note':
    '이 Skill이 올바르게 작동하려면 의존하는 Skill을 먼저 업로드해야 합니다. 지금 업로드하고 나중에 의존성을 추가할 수도 있습니다.',
  'claudeApi.dependentSkillsLabel': '의존 Skill:',
  'claudeApi.notUploadedSuffix': '(업로드되지 않음)',
  'claudeApi.upload': '업로드',
  'claudeApi.uploadAllMissing': '누락된 항목 모두 업로드',
  'claudeApi.retry': '다시 시도',
  'claudeApi.sameNameNote': '같은 이름의 Skill이 이미 있으면 새 버전이 생성됩니다.',
  'claudeApi.back': '뒤로',
  'claudeApi.uploadingToApi': 'Claude API에 업로드 중...',
  'claudeApi.uploadFailed': '업로드에 실패했습니다',
  'claudeApi.newVersionCreated': '새 버전이 생성되었습니다!',
  'claudeApi.skillUploaded': 'Skill이 업로드되었습니다!',
  'claudeApi.skillIdLabel': 'Skill ID:',
  'claudeApi.copy': '복사',
  'claudeApi.copied': '복사했습니다!',
  'claudeApi.copyToClipboard': '클립보드에 복사',
  'claudeApi.versionLabel': '버전: {version}',
  'claudeApi.backToList': '목록으로 돌아가기',
  'claudeApi.test': '테스트',
  'claudeApi.tab.code': '코드',
  'claudeApi.skillLabel': 'Skill:',
  'claudeApi.uploadedByStudio': '(cc-wf-studio에서 업로드됨)',
  'claudeApi.loadingSkillDetails': 'Skill 상세 정보를 불러오는 중...',
  'claudeApi.model': '모델',
  'claudeApi.language': '언어',
  'claudeApi.languagePlaceholder': '예: Korean, English',
  'claudeApi.additionalSkills': '추가 Skill',
  'claudeApi.requiredBadge': '필수',
  'claudeApi.notYetUploaded': '아직 업로드되지 않음: {names}',
  'claudeApi.sendMessageToTest': '메시지를 보내 Skill을 테스트하세요.',
  'claudeApi.uploadSkillsFirst': '먼저 다음 Skill을 업로드하세요: {names}',
  'claudeApi.requiredSkillsNotSelected': '필수 추가 Skill이 선택되지 않았습니다',
  'claudeApi.mcpUrlsMissing': 'MCP 서버 URL 또는 Token이 입력되지 않았습니다: {names}',
  'claudeApi.resetConversationMessage': '채팅 기록이 지워집니다. 계속하시겠습니까?',
  'claudeApi.reset': '리셋',
  'claudeApi.totalUsage': '총 사용량:',
  'claudeApi.totalTokensTooltip': '합계: {total} 토큰',
  'claudeApi.requiredSkillsMissingTooltip': '필수 추가 Skill이 부족합니다',
  'claudeApi.enterMcpUrlsFirst': '먼저 MCP 서버 URL을 입력하세요',
  'claudeApi.sendMessage': '메시지 보내기',
  'claudeApi.executionFailed': '실행에 실패했습니다',
  'claudeApi.deleteSkill.title': 'Skill 삭제',
  'claudeApi.deleteSkill.message':
    '"{title}"을(를) 삭제하시겠습니까? 이 작업은 되돌릴 수 없습니다.',
  'claudeApi.deleting': '삭제 중...',
  'claudeApi.deleteSkillFailed': 'Skill 삭제에 실패했습니다',
  'claudeApi.defaultTestPrompt': '워크플로우를 실행해 주세요.',
  'claudeApi.mcpServerUrls': 'MCP 서버 URL',
  'claudeApi.remoteMcpOnly': 'Claude API는 원격 HTTP MCP 서버(type: url)만 지원합니다.',
  'claudeApi.dontKnowUrl': 'URL을 모르시나요?',
  'claudeApi.needAuthentication': '인증이 필요한가요?',
  'claudeApi.enterBearerToken': 'Bearer Token 입력',
  'claudeApi.pastePatOrApiKey': 'PAT 또는 API 키를 붙여넣으세요.',
  'claudeApi.or': '또는',
  'claudeApi.obtainTokenViaOauth': 'OAuth로 토큰 얻기',
  'claudeApi.useInspector.before': 'OAuth 플로우를 완료하려면',
  'claudeApi.useInspector.after': '을 사용하세요:',
  'claudeApi.authIntro.before': 'OAuth가 필요한 MCP 서버의 경우 access_token을',
  'claudeApi.authIntro.after': '로 얻으세요:',
  'claudeApi.authStep.run': '실행:',
  'claudeApi.authStep.sidebar':
    '사이드바에서 transport type을 선택하고 서버 URL을 입력한 후 "Connect"를 클릭',
  'claudeApi.authStep.mainArea': '메인 영역에서 "Open Auth Settings" → "Quick OAuth Flow"를 클릭',
  'claudeApi.authStep.copyToken.before':
    '인증을 완료하고 OAuth Flow Progress 하단의 "Access Token"을 펼친 후 JSON에서',
  'claudeApi.authStep.copyToken.after': '값을 복사',
  ...
  'commentary.options.title': 'Commentary AI 옵션',
  'commentary.options.provider': '프로바이더',
  'commentary.options.language': '언어',
  'commentary.options.model': '모델',
  'commentary.options.noModels': '사용 가능한 모델이 없습니다',
