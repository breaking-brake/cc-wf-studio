...
export const enWebviewTranslations: WebviewTranslationKeys = {
  ...
  'shortcuts.tooltip': 'Keyboard shortcuts',
  ...
  'shortcuts.ungroup': 'Ungroup selection',
  'shortcuts.nudge': 'Nudge selection',
  'shortcuts.nudgeLarge': 'Nudge selection (larger step)',
  ...
  'shortcuts.toggleInteraction': 'Temporarily switch pan / box-select',
  'shortcuts.gesture.arrowKeys': 'Arrow keys',
  'shortcuts.gesture.rightClick': 'Right-click',
  'shortcuts.gesture.dragToCanvas': 'Drag edge to canvas',
  'shortcuts.gesture.drag': 'Drag',
  ...
  'askUserQuestion.field.options': 'Options ({count}/4)',
  'askUserQuestion.field.options.item': 'Option {number}',
  'askUserQuestion.field.options.add': '+ Add Option',
  'branch.field.branchType': 'Branch Type',
  'branch.field.branchType.option.conditional': 'Conditional (2-way)',
  'branch.field.branchType.option.switch': 'Switch (Multi-way)',
  'branch.field.branches': 'Branches ({count})',
  'branch.field.branches.item': 'Branch {number}',
  'branch.field.branches.add': '+ Add Branch',
  'ifElse.field.evaluationTarget': 'Evaluation Target',
  'ifElse.field.evaluationTarget.placeholder': 'e.g., Result of the previous step',
  'ifElse.field.evaluationTarget.help': 'Describe what to evaluate in the branch condition',
  'ifElse.field.branches': 'Branches ({count})',
  'ifElse.field.branches.item': 'Branch {number}',
  'switch.field.evaluationTarget': 'Evaluation Target',
  'switch.field.evaluationTarget.placeholder': 'e.g., Result of the previous step',
  'switch.field.evaluationTarget.help': 'Describe what to evaluate in the branch condition',
  'switch.field.branches': 'Branches ({count})',
  'switch.field.branches.item': 'Branch {number}',
  'switch.field.branches.add': '+ Add Branch',
  ...
  'subAgent.field.agentType': 'Agent Type',
  'subAgent.field.model': 'Model',
  'subAgent.field.tools': 'Tools (comma-separated)',
  'subAgent.field.memory': 'Memory',
  'subAgent.field.color': 'Color',
  'subAgent.field.builtInType': 'Built-in Type',
  ...
  'claudeApi.title.apiTest': 'API Test',
  'claudeApi.title.apiKeyRequired': 'API Key Required',
  'claudeApi.checkingApiKey': 'Checking API key...',
  'claudeApi.enterApiKeyIntro':
    "Enter your Anthropic API key to deploy and manage skills. The key will be stored securely in VS Code's secret storage. You can create an API key",
  'claudeApi.enterApiKeyIntro.linkLabel': 'here',
  'claudeApi.enterApiKeyIntro.after': '.',
  'claudeApi.apiKeyLabel': 'API Key',
  'claudeApi.apiKeyInvalidPrefix': 'API key must start with "sk-ant-"',
  'claudeApi.apiKeySaveFailed': 'Failed to save API key',
  'claudeApi.deleteApiKey': 'Delete API Key',
  'claudeApi.deleteApiKeyConfirm': 'Delete API key? You will need to enter a new key to continue.',
  'claudeApi.apiKeyDeleted': 'API key has been deleted.',
  'claudeApi.saveAndContinue': 'Save & Continue',
  'claudeApi.loadingSkills': 'Loading skills...',
  'claudeApi.loadSkillsFailed': 'Failed to load skills',
  'claudeApi.uploadedSkills': 'Uploaded Skills',
  'claudeApi.noSkillsFound': 'No custom skills found. Upload your first workflow!',
  'claudeApi.delete': 'Delete',
  'claudeApi.changeApiKey': 'Change API Key',
  'claudeApi.uploadNew': 'Upload New',
  'claudeApi.workflowToUpload': 'Workflow to upload:',
  'claudeApi.untitled': 'Untitled',
  'claudeApi.mcpNodesWarning.title': 'This workflow contains MCP Tool nodes',
  'claudeApi.mcpNodesWarning.body':
    'Claude API only supports remote HTTP MCP servers (type: url). Local stdio servers cannot be used. You will need to set the server URLs in the Sample Code / Test screen after uploading.',
  'claudeApi.dependentSkills.title': 'This workflow depends on other skills',
  'claudeApi.dependentSkills.note':
    'Dependent skills must be uploaded before this skill can work correctly. You can still upload now and add dependencies later.',
  'claudeApi.dependentSkillsLabel': 'Dependent Skills:',
  'claudeApi.notUploadedSuffix': '(not uploaded)',
  'claudeApi.upload': 'Upload',
  'claudeApi.uploadAllMissing': 'Upload All Missing',
  'claudeApi.retry': 'Retry',
  'claudeApi.sameNameNote':
    'If a skill with the same name already exists, a new version will be created.',
  'claudeApi.back': 'Back',
  'claudeApi.uploadingToApi': 'Uploading to Claude API...',
  'claudeApi.uploadFailed': 'Upload failed',
  'claudeApi.newVersionCreated': 'New version created successfully!',
  'claudeApi.skillUploaded': 'Skill uploaded successfully!',
  'claudeApi.skillIdLabel': 'Skill ID:',
  'claudeApi.copy': 'Copy',
  'claudeApi.copied': 'Copied!',
  'claudeApi.copyToClipboard': 'Copy to clipboard',
  'claudeApi.versionLabel': 'Version: {version}',
  'claudeApi.backToList': 'Back to List',
  'claudeApi.test': 'Test',
  'claudeApi.tab.code': 'Code',
  'claudeApi.skillLabel': 'Skill:',
  'claudeApi.uploadedByStudio': '(uploaded by cc-wf-studio)',
  'claudeApi.loadingSkillDetails': 'Loading skill details...',
  'claudeApi.model': 'Model',
  'claudeApi.language': 'Language',
  'claudeApi.languagePlaceholder': 'e.g. Japanese, English',
  'claudeApi.additionalSkills': 'Additional Skills',
  'claudeApi.requiredBadge': 'required',
  'claudeApi.notYetUploaded': 'Not yet uploaded: {names}',
  'claudeApi.sendMessageToTest': 'Send a message to test the skill.',
  'claudeApi.uploadSkillsFirst': 'Upload the following skills first: {names}',
  'claudeApi.requiredSkillsNotSelected': 'Required additional skills are not selected',
  'claudeApi.mcpUrlsMissing': 'MCP server URL or token is missing: {names}',
  'claudeApi.resetConversationMessage': 'Chat history will be cleared. Continue?',
  'claudeApi.reset': 'Reset',
  'claudeApi.totalUsage': 'Total Usage:',
  'claudeApi.totalTokensTooltip': 'Total: {total} tokens',
  'claudeApi.requiredSkillsMissingTooltip': 'Required additional skills are missing',
  'claudeApi.enterMcpUrlsFirst': 'Enter MCP server URLs first',
  'claudeApi.sendMessage': 'Send message',
  'claudeApi.executionFailed': 'Execution failed',
  'claudeApi.deleteSkill.title': 'Delete Skill',
  'claudeApi.deleteSkill.message':
    'Are you sure you want to delete "{title}"? This action cannot be undone.',
  'claudeApi.deleting': 'Deleting...',
  'claudeApi.deleteSkillFailed': 'Failed to delete skill',
  'claudeApi.defaultTestPrompt': 'Please execute the workflow.',
  'claudeApi.mcpServerUrls': 'MCP Server URLs',
  'claudeApi.remoteMcpOnly': 'Claude API supports remote HTTP MCP servers only (type: url).',
  'claudeApi.dontKnowUrl': "Don't know the URL?",
  'claudeApi.needAuthentication': 'Need authentication?',
  'claudeApi.enterBearerToken': 'Enter Bearer Token',
  'claudeApi.pastePatOrApiKey': 'Paste a PAT or API key.',
  'claudeApi.or': 'or',
  'claudeApi.obtainTokenViaOauth': 'Obtain Token via OAuth',
  'claudeApi.useInspector.before': 'Use',
  'claudeApi.useInspector.after': 'to complete OAuth flow:',
  'claudeApi.authIntro.before': 'For MCP servers requiring OAuth, obtain an access_token via',
  'claudeApi.authIntro.after': ':',
  'claudeApi.authStep.run': 'Run:',
  ...
  'claudeApi.authStep.copyToken.before':
    'Complete authorization, expand "Access Token" at the bottom of OAuth Flow Progress, and copy the',
  'claudeApi.authStep.copyToken.after': 'value from the JSON',
  ...
  'commentary.options.title': 'Commentary options',
  'commentary.options.provider': 'Provider',
  'commentary.options.language': 'Language',
  'commentary.options.model': 'Model',
  'commentary.options.noModels': 'No models available',
