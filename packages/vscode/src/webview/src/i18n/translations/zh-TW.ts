...
export const zhTWWebviewTranslations: WebviewTranslationKeys = {
  ...
  'overview.zoomIn': '放大',
  'overview.zoomOut': '縮小',
  'overview.fitView': '符合檢視',
  'overview.followActive.on': '跟隨作用中節點：開',
  'overview.followActive.off': '跟隨作用中節點：關',
  'overview.layout.td': '版面配置：由上到下（點擊切換為由左到右）',
  'overview.layout.lr': '版面配置：由左到右（點擊切換為由上到下）',
  'overview.resizePanels': '調整檢視面板大小',
  'overview.editNodeLink': '切換至編輯模式並定位到此節點',
  ...
  'toolbar.saving': '儲存中...',
  'toolbar.export': '匯出',
  'toolbar.export.tooltip': '匯出為 Slash Command 並儲存到 .claude/skills/',
  ...
  'workflowTour.title': '工作流程導覽',
  'workflowTour.start': '開始工作流程導覽',
  'workflowTour.start.tooltip': '開始工作流程導覽（{count} 個步驟）',
  'workflowTour.generate': '產生工作流程導覽',
  'workflowTour.generate.tooltip': '產生工作流程導覽',
  'workflowTour.noTour': '此工作流程沒有引導導覽。',
  'workflowTour.noTourLabel': '無工作流程導覽',
  'workflowTour.prev': '上一步',
  'workflowTour.end': '結束工作流程導覽',
  'workflowTour.regenerate': '重新產生',
  'workflowTour.regenerate.tooltip': '使用AI代理重新產生此導覽',
  'workflowTour.regenerate.aria': '重新產生工作流程導覽',
  'workflowTour.popover.agent': '代理',
  'workflowTour.popover.emptyHeading': '還沒有工作流程導覽',
  'workflowTour.popover.emptyDescription': '使用AI代理產生此工作流程的逐步導覽。',
  'workflowTour.popover.generating': '產生中…',
  'workflowTour.popover.regenerateHeading': '重新產生工作流程導覽',
  'workflowTour.popover.regenerateDescription': '以新產生的導覽取代目前的導覽。',
  'workflowTour.popover.regenerateButton': '重新產生導覽',
  ...
  'problemsPanel.workflowScope': '工作流程',
  'problemsPanel.jumpTooltip': '跳轉到節點',
  ...
  'shortcuts.cut': '剪下所選內容',
  'shortcuts.paste': '貼上',
  'shortcuts.duplicate': '為所選內容建立複本',
  'shortcuts.group': '將所選內容群組',
  'shortcuts.ungroup': '取消所選內容的群組',
  'shortcuts.nudge': '移動所選節點',
  'shortcuts.nudgeLarge': '大幅移動所選節點',
  ...
  'shortcuts.toggleInteraction': '暫時切換平移/框選',
  'shortcuts.gesture.arrowKeys': '方向鍵',
  'shortcuts.gesture.rightClick': '右鍵點擊',
  'shortcuts.gesture.dragToCanvas': '將連線拖曳到畫布',
  'shortcuts.gesture.drag': '拖曳',
  ...
  'toolbar.saveAsImage': '儲存為圖片',
  'toolbar.saveAsImageSaved': '已儲存',
  'toolbar.saveAsImageFailed': '儲存畫布圖片失敗',
  ...
  'skill.field.scope': '範圍',
  'skill.field.validationStatus': '驗證狀態',
  'skill.field.allowedTools': '允許的工具',
  'skill.field.executionMode': '執行模式',
  'skill.field.executionPrompt': '提示詞',
  'skill.field.source': '來源',
  'skill.field.pluginName': '插件名稱',
  'mcp.field.serverId': '伺服器',
  'mcp.field.toolName': '工具名稱',
  'mcp.field.toolDescription': '描述',
  'mcp.field.validationStatus': '驗證狀態',
  'mcp.field.parameters': '參數數量',
  'mcp.field.mode': '模式',
  'mcp.field.aiToolSelectionConfig': '任務內容',
  'mcp.field.aiParameterConfig': '參數內容',
  'mcp.field.parameterValues': '配置值',
  'subAgentFlow.field.subAgentFlowId': 'Sub-Agent Flow ID',
  'subAgentFlow.field.label': '標籤',
  'subAgentFlow.field.description': '描述',
  'subAgentFlow.field.model': '模型',
  ...
  'subAgentFlow.field.memory': '記憶',
  'subAgentFlow.field.tools': '工具（逗號分隔）',
  'subAgentFlow.field.tools.placeholder': '例如：Read,Write,Bash',
  'subAgentFlow.field.tools.help': '留空表示所有工具',
  'subAgentFlow.field.color': '顏色',
  'askUserQuestion.field.questionText': '問題',
  'askUserQuestion.field.multiSelect': '多選',
  'askUserQuestion.field.useAiSuggestions': 'AI建議選項',
  'askUserQuestion.field.options': '選項（{count}/4）',
  'askUserQuestion.field.options.item': '選項 {number}',
  'askUserQuestion.field.options.add': '+ 新增選項',
  'branch.field.branchType': '分支類型',
  'branch.field.branchType.option.conditional': '條件（雙向）',
  'branch.field.branchType.option.switch': '切換（多向）',
  'branch.field.branches': '分支（{count}）',
  'branch.field.branches.item': '分支 {number}',
  'branch.field.branches.add': '+ 新增分支',
  'ifElse.field.evaluationTarget': '評估目標',
  'ifElse.field.evaluationTarget.placeholder': '例如：前一步驟的執行結果',
  'ifElse.field.evaluationTarget.help': '用自然語言描述分支條件中要評估的內容',
  'ifElse.field.branches': '分支（{count}）',
  'ifElse.field.branches.item': '分支 {number}',
  'switch.field.evaluationTarget': '評估目標',
  'switch.field.evaluationTarget.placeholder': '例如：前一步驟的執行結果',
  'switch.field.evaluationTarget.help': '用自然語言描述分支條件中要評估的內容',
  'switch.field.branches': '分支（{count}）',
  'switch.field.branches.item': '分支 {number}',
  'switch.field.branches.add': '+ 新增分支',
  'prompt.field.label': '標籤',
  'prompt.field.label.placeholder': '輸入標籤',
  'prompt.field.prompt': '提示詞',
  'prompt.field.prompt.placeholder': '輸入包含{{variables}}的提示詞',
  'prompt.field.prompt.help': '對動態值使用{{variableName}}語法',
  'prompt.field.variables': '變數',
  'branchSession.field.label': '標籤',
  'branchSession.field.label.placeholder': '輸入標籤',
  'branchSession.field.workDescription': '工作內容',
  'branchSession.field.workDescription.placeholder':
    '使用者與AI在分支工作階段中共同完成的工作內容（可選）',
  'branchSession.field.workDescription.help': '將嵌入產生的指令中，使工作階段了解協作範圍',
  'codex.field.label': '節點名稱',
  'codex.field.label.help': '用於匯出的檔案名稱（例如："data-analysis"）',
  'codex.field.promptMode': '提示模式',
  'codex.field.promptMode.option.fixed': '固定',
  'codex.field.promptMode.option.ai-generated': 'AI生成',
  'codex.field.prompt': '提示詞',
  'codex.field.prompt.placeholder': '輸入Codex代理的指令...',
  'codex.field.model': '模型',
  'codex.field.reasoningEffort': '推理等級',
  ...
  'codex.field.sandbox': '沙箱模式',
  'codex.section.advanced': '進階選項',
  'group.field.label': '節點名稱',
  'group.field.label.placeholder': 'Group',
  'subAgent.field.description': '描述',
  'subAgent.field.agentDefinition': '代理定義',
  'subAgent.field.prompt': '提示詞',
  'subAgent.field.agentType': '代理類型',
  'subAgent.field.model': '模型',
  'subAgent.field.tools': '工具（逗號分隔）',
  'subAgent.field.memory': '記憶',
  'subAgent.field.color': '顏色',
  'subAgent.field.builtInType': '內建類型',
  'subAgent.section.claudeCode': 'Claude Code 設定',
  'subAgent.section.claudeCode.hint': '將此子代理匯出至 Claude Code 時套用。',
  'subAgent.section.other': '其他 Agent 設定',
  'subAgent.section.other.empty': '尚無此 Agent 專屬設定 — 其他 Agent 僅使用通用設定。',
  ...
  'claudeApi.title.apiTest': 'API 測試',
  'claudeApi.title.apiKeyRequired': '需要 API 金鑰',
  'claudeApi.checkingApiKey': '正在檢查 API 金鑰...',
  'claudeApi.enterApiKeyIntro':
    '輸入您的 Anthropic API 金鑰即可部署和管理 Skill。金鑰將安全地儲存在 VS Code 的密鑰儲存空間中。您可以在',
  'claudeApi.enterApiKeyIntro.linkLabel': '這裡',
  'claudeApi.enterApiKeyIntro.after': '建立 API 金鑰。',
  'claudeApi.apiKeyLabel': 'API 金鑰',
  'claudeApi.apiKeyInvalidPrefix': 'API 金鑰必須以 "sk-ant-" 開頭',
  'claudeApi.apiKeySaveFailed': '儲存 API 金鑰失敗',
  'claudeApi.deleteApiKey': '刪除 API 金鑰',
  'claudeApi.deleteApiKeyConfirm': '刪除 API 金鑰？您需要輸入新金鑰才能繼續。',
  'claudeApi.apiKeyDeleted': 'API 金鑰已刪除。',
  'claudeApi.saveAndContinue': '儲存並繼續',
  'claudeApi.loadingSkills': '正在載入 Skill...',
  'claudeApi.loadSkillsFailed': '載入 Skill 失敗',
  'claudeApi.uploadedSkills': '已上傳的 Skill',
  'claudeApi.noSkillsFound': '找不到自訂 Skill。上傳您的第一個工作流程吧！',
  'claudeApi.delete': '刪除',
  'claudeApi.changeApiKey': '變更 API 金鑰',
  'claudeApi.uploadNew': '上傳新的',
  'claudeApi.workflowToUpload': '要上傳的工作流程:',
  'claudeApi.untitled': '未命名',
  'claudeApi.mcpNodesWarning.title': '此工作流程包含 MCP Tool 節點',
  'claudeApi.mcpNodesWarning.body':
    'Claude API 僅支援遠端 HTTP MCP 伺服器（type: url）。無法使用本機 stdio 伺服器。上傳後需要在 Sample Code / Test 畫面設定伺服器 URL。',
  'claudeApi.dependentSkills.title': '此工作流程依賴其他 Skill',
  'claudeApi.dependentSkills.note':
    '必須先上傳依賴的 Skill，此 Skill 才能正常運作。您也可以現在上傳，稍後再新增依賴。',
  'claudeApi.dependentSkillsLabel': '依賴的 Skill:',
  'claudeApi.notUploadedSuffix': '（未上傳）',
  'claudeApi.upload': '上傳',
  'claudeApi.uploadAllMissing': '上傳所有缺少項目',
  'claudeApi.retry': '重試',
  'claudeApi.sameNameNote': '如果已存在同名 Skill，將建立新版本。',
  'claudeApi.back': '返回',
  'claudeApi.uploadingToApi': '正在上傳到 Claude API...',
  'claudeApi.uploadFailed': '上傳失敗',
  'claudeApi.newVersionCreated': '新版本建立成功！',
  'claudeApi.skillUploaded': 'Skill 上傳成功！',
  'claudeApi.skillIdLabel': 'Skill ID:',
  'claudeApi.copy': '複製',
  'claudeApi.copied': '已複製！',
  'claudeApi.copyToClipboard': '複製到剪貼簿',
  'claudeApi.versionLabel': '版本: {version}',
  'claudeApi.backToList': '返回清單',
  'claudeApi.test': '測試',
  'claudeApi.tab.code': '程式碼',
  'claudeApi.skillLabel': 'Skill:',
  'claudeApi.uploadedByStudio': '（由 cc-wf-studio 上傳）',
  'claudeApi.loadingSkillDetails': '正在載入 Skill 詳細資訊...',
  'claudeApi.model': '模型',
  'claudeApi.language': '語言',
  'claudeApi.languagePlaceholder': '例如: Chinese, English',
  'claudeApi.additionalSkills': '附加 Skill',
  'claudeApi.requiredBadge': '必要',
  'claudeApi.notYetUploaded': '尚未上傳: {names}',
  'claudeApi.sendMessageToTest': '傳送訊息以測試該 Skill。',
  'claudeApi.uploadSkillsFirst': '請先上傳以下 Skill: {names}',
  'claudeApi.requiredSkillsNotSelected': '未選擇必要的附加 Skill',
  'claudeApi.mcpUrlsMissing': '未填寫 MCP 伺服器的 URL 或 Token: {names}',
  'claudeApi.resetConversationMessage': '聊天記錄將被清除。是否繼續？',
  'claudeApi.reset': '重設',
  'claudeApi.totalUsage': '總用量:',
  'claudeApi.totalTokensTooltip': '合計: {total} 個 token',
  'claudeApi.requiredSkillsMissingTooltip': '缺少必要的附加 Skill',
  'claudeApi.enterMcpUrlsFirst': '請先輸入 MCP 伺服器 URL',
  'claudeApi.sendMessage': '傳送訊息',
  'claudeApi.executionFailed': '執行失敗',
  'claudeApi.deleteSkill.title': '刪除 Skill',
  'claudeApi.deleteSkill.message': '確定要刪除「{title}」嗎？此操作無法復原。',
  'claudeApi.deleting': '正在刪除...',
  'claudeApi.deleteSkillFailed': '刪除 Skill 失敗',
  'claudeApi.defaultTestPrompt': '請執行該工作流程。',
  'claudeApi.mcpServerUrls': 'MCP 伺服器 URL',
  'claudeApi.remoteMcpOnly': 'Claude API 僅支援遠端 HTTP MCP 伺服器（type: url）。',
  'claudeApi.dontKnowUrl': '不知道 URL？',
  'claudeApi.needAuthentication': '需要身分驗證？',
  'claudeApi.enterBearerToken': '輸入 Bearer Token',
  'claudeApi.pastePatOrApiKey': '貼上 PAT 或 API 金鑰。',
  'claudeApi.or': '或',
  'claudeApi.obtainTokenViaOauth': '透過 OAuth 取得權杖',
  'claudeApi.useInspector.before': '使用',
  'claudeApi.useInspector.after': '完成 OAuth 流程:',
  'claudeApi.authIntro.before': '對於需要 OAuth 的 MCP 伺服器，請透過',
  'claudeApi.authIntro.after': '取得 access_token:',
  'claudeApi.authStep.run': '執行:',
  'claudeApi.authStep.sidebar': '在側邊欄中選擇 transport type，輸入伺服器 URL，然後點擊 "Connect"',
  'claudeApi.authStep.mainArea': '在主區域中點擊 "Open Auth Settings" → "Quick OAuth Flow"',
  'claudeApi.authStep.copyToken.before':
    '完成授權後，展開 OAuth Flow Progress 底部的 "Access Token"，從 JSON 中複製',
  'claudeApi.authStep.copyToken.after': '的值',
  ...
  'commentary.options.title': 'Commentary AI 選項',
  'commentary.options.provider': '提供商',
  'commentary.options.language': '語言',
  'commentary.options.model': '模型',
  'commentary.options.noModels': '沒有可用的模型',
