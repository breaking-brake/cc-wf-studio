...
export const zhCNWebviewTranslations: WebviewTranslationKeys = {
  ...
  'overview.zoomIn': '放大',
  'overview.zoomOut': '缩小',
  'overview.fitView': '适应视图',
  'overview.followActive.on': '跟随活动节点：开',
  'overview.followActive.off': '跟随活动节点：关',
  'overview.layout.td': '布局：从上到下（点击切换为从左到右）',
  'overview.layout.lr': '布局：从左到右（点击切换为从上到下）',
  'overview.resizePanels': '调整视图面板大小',
  'overview.editNodeLink': '切换到编辑模式并定位到此节点',
  ...
  'workflowTour.title': '工作流导览',
  'workflowTour.start': '开始工作流导览',
  'workflowTour.start.tooltip': '开始工作流导览（{count} 个步骤）',
  'workflowTour.generate': '生成工作流导览',
  'workflowTour.generate.tooltip': '生成工作流导览',
  'workflowTour.noTour': '此工作流没有引导导览。',
  'workflowTour.noTourLabel': '无工作流导览',
  'workflowTour.prev': '上一步',
  'workflowTour.end': '结束工作流导览',
  'workflowTour.regenerate': '重新生成',
  'workflowTour.regenerate.tooltip': '使用AI代理重新生成此导览',
  'workflowTour.regenerate.aria': '重新生成工作流导览',
  'workflowTour.popover.agent': '代理',
  'workflowTour.popover.emptyHeading': '还没有工作流导览',
  'workflowTour.popover.emptyDescription': '使用AI代理生成此工作流的分步导览。',
  'workflowTour.popover.generating': '生成中…',
  'workflowTour.popover.regenerateHeading': '重新生成工作流导览',
  'workflowTour.popover.regenerateDescription': '用新生成的导览替换当前导览。',
  'workflowTour.popover.regenerateButton': '重新生成导览',
  ...
  'contextMenu.groupSelection': '编组',
  'contextMenu.ungroupSelection': '取消编组',
  ...
  'shortcuts.cut': '剪切所选内容',
  'shortcuts.paste': '粘贴',
  'shortcuts.duplicate': '为所选内容创建副本',
  'shortcuts.group': '将所选内容编组',
  'shortcuts.ungroup': '取消所选内容的编组',
  'shortcuts.nudge': '移动所选节点',
  'shortcuts.nudgeLarge': '大幅移动所选节点',
  ...
  'shortcuts.toggleInteraction': '临时切换平移/框选',
  'shortcuts.gesture.arrowKeys': '方向键',
  'shortcuts.gesture.rightClick': '右键点击',
  'shortcuts.gesture.dragToCanvas': '将连线拖到画布',
  'shortcuts.gesture.drag': '拖动',
  ...
  'toolbar.saveAsImage': '保存为图片',
  'toolbar.saveAsImageSaved': '已保存',
  'toolbar.saveAsImageFailed': '保存画布图片失败',
  ...
  'skill.field.scope': '范围',
  'skill.field.validationStatus': '验证状态',
  'skill.field.allowedTools': '允许的工具',
  'skill.field.executionMode': '执行模式',
  'skill.field.executionPrompt': '提示词',
  'skill.field.source': '来源',
  'skill.field.pluginName': '插件名称',
  'mcp.field.serverId': '服务器',
  'mcp.field.toolName': '工具名称',
  'mcp.field.toolDescription': '描述',
  'mcp.field.validationStatus': '验证状态',
  'mcp.field.parameters': '参数数量',
  'mcp.field.mode': '模式',
  'mcp.field.aiToolSelectionConfig': '任务内容',
  'mcp.field.aiParameterConfig': '参数内容',
  'mcp.field.parameterValues': '配置值',
  'subAgentFlow.field.subAgentFlowId': 'Sub-Agent Flow ID',
  'subAgentFlow.field.label': '标签',
  ...
  'subAgentFlow.field.memory': '记忆',
  'subAgentFlow.field.tools': '工具（逗号分隔）',
  'subAgentFlow.field.tools.placeholder': '例如：Read,Write,Bash',
  'subAgentFlow.field.tools.help': '留空表示所有工具',
  'subAgentFlow.field.color': '颜色',
  'askUserQuestion.field.questionText': '问题',
  'askUserQuestion.field.multiSelect': '多选',
  'askUserQuestion.field.useAiSuggestions': 'AI建议选项',
  'askUserQuestion.field.options': '选项（{count}/4）',
  'askUserQuestion.field.options.item': '选项 {number}',
  'askUserQuestion.field.options.add': '+ 添加选项',
  'branch.field.branchType': '分支类型',
  'branch.field.branchType.option.conditional': '条件（双向）',
  'branch.field.branchType.option.switch': '开关（多向）',
  'branch.field.branches': '分支（{count}）',
  'branch.field.branches.item': '分支 {number}',
  'branch.field.branches.add': '+ 添加分支',
  'ifElse.field.evaluationTarget': '评估目标',
  'ifElse.field.evaluationTarget.placeholder': '例如：前一步的执行结果',
  'ifElse.field.evaluationTarget.help': '用自然语言描述分支条件中要评估的内容',
  'ifElse.field.branches': '分支（{count}）',
  'ifElse.field.branches.item': '分支 {number}',
  'switch.field.evaluationTarget': '评估目标',
  'switch.field.evaluationTarget.placeholder': '例如：前一步的执行结果',
  'switch.field.evaluationTarget.help': '用自然语言描述分支条件中要评估的内容',
  'switch.field.branches': '分支（{count}）',
  'switch.field.branches.item': '分支 {number}',
  'switch.field.branches.add': '+ 添加分支',
  'prompt.field.label': '标签',
  'prompt.field.label.placeholder': '输入标签',
  'prompt.field.prompt': '提示词',
  'prompt.field.prompt.placeholder': '输入包含{{variables}}的提示词',
  'prompt.field.prompt.help': '对动态值使用{{variableName}}语法',
  'prompt.field.variables': '变量',
  'branchSession.field.label': '标签',
  'branchSession.field.label.placeholder': '输入标签',
  'branchSession.field.workDescription': '工作内容',
  'branchSession.field.workDescription.placeholder':
    '用户与AI在分支会话中共同完成的工作内容（可选）',
  'branchSession.field.workDescription.help': '将嵌入生成的指令中，使会话了解协作范围',
  'codex.field.label': '节点名称',
  'codex.field.label.help': '用于导出的文件名（例如："data-analysis"）',
  'codex.field.promptMode': '提示模式',
  'codex.field.promptMode.option.fixed': '固定',
  'codex.field.promptMode.option.ai-generated': 'AI生成',
  'codex.field.prompt': '提示词',
  'codex.field.prompt.placeholder': '输入Codex代理的指令...',
  'codex.field.model': '模型',
  'codex.field.reasoningEffort': '推理级别',
  ...
  'codex.section.advanced': '高级选项',
  'group.field.label': '节点名称',
  'group.field.label.placeholder': 'Group',
  'subAgent.field.description': '描述',
  'subAgent.field.agentDefinition': '代理定义',
  'subAgent.field.prompt': '提示词',
  'subAgent.field.agentType': '代理类型',
  'subAgent.field.model': '模型',
  'subAgent.field.tools': '工具（逗号分隔）',
  'subAgent.field.memory': '记忆',
  'subAgent.field.color': '颜色',
  'subAgent.field.builtInType': '内置类型',
  'subAgent.section.claudeCode': 'Claude Code 设置',
  'subAgent.section.claudeCode.hint': '将该子代理导出到 Claude Code 时应用。',
  'subAgent.section.other': '其他 Agent 设置',
  'subAgent.section.other.empty': '暂无该 Agent 专属设置 — 其他 Agent 仅使用通用设置。',
  ...
  'claudeApi.title.apiTest': 'API 测试',
  'claudeApi.title.apiKeyRequired': '需要 API 密钥',
  'claudeApi.checkingApiKey': '正在检查 API 密钥...',
  'claudeApi.enterApiKeyIntro':
    '输入您的 Anthropic API 密钥即可部署和管理 Skill。密钥将安全地存储在 VS Code 的密钥存储中。您可以在',
  'claudeApi.enterApiKeyIntro.linkLabel': '这里',
  'claudeApi.enterApiKeyIntro.after': '创建 API 密钥。',
  'claudeApi.apiKeyLabel': 'API 密钥',
  'claudeApi.apiKeyInvalidPrefix': 'API 密钥必须以 "sk-ant-" 开头',
  'claudeApi.apiKeySaveFailed': '保存 API 密钥失败',
  'claudeApi.deleteApiKey': '删除 API 密钥',
  'claudeApi.deleteApiKeyConfirm': '删除 API 密钥？您需要输入新密钥才能继续。',
  'claudeApi.apiKeyDeleted': 'API 密钥已删除。',
  'claudeApi.saveAndContinue': '保存并继续',
  'claudeApi.loadingSkills': '正在加载 Skill...',
  'claudeApi.loadSkillsFailed': '加载 Skill 失败',
  'claudeApi.uploadedSkills': '已上传的 Skill',
  'claudeApi.noSkillsFound': '未找到自定义 Skill。上传您的第一个工作流吧！',
  'claudeApi.delete': '删除',
  'claudeApi.changeApiKey': '更改 API 密钥',
  'claudeApi.uploadNew': '上传新的',
  'claudeApi.workflowToUpload': '要上传的工作流:',
  'claudeApi.untitled': '无标题',
  'claudeApi.mcpNodesWarning.title': '此工作流包含 MCP Tool 节点',
  'claudeApi.mcpNodesWarning.body':
    'Claude API 仅支持远程 HTTP MCP 服务器（type: url）。无法使用本地 stdio 服务器。上传后需要在 Sample Code / Test 界面设置服务器 URL。',
  'claudeApi.dependentSkills.title': '此工作流依赖其他 Skill',
  'claudeApi.dependentSkills.note':
    '必须先上传依赖的 Skill，此 Skill 才能正常工作。您也可以现在上传，稍后再添加依赖。',
  'claudeApi.dependentSkillsLabel': '依赖的 Skill:',
  'claudeApi.notUploadedSuffix': '（未上传）',
  'claudeApi.upload': '上传',
  'claudeApi.uploadAllMissing': '上传所有缺失项',
  'claudeApi.retry': '重试',
  'claudeApi.sameNameNote': '如果已存在同名 Skill，将创建新版本。',
  'claudeApi.back': '返回',
  'claudeApi.uploadingToApi': '正在上传到 Claude API...',
  'claudeApi.uploadFailed': '上传失败',
  'claudeApi.newVersionCreated': '新版本创建成功！',
  'claudeApi.skillUploaded': 'Skill 上传成功！',
  'claudeApi.skillIdLabel': 'Skill ID:',
  'claudeApi.copy': '复制',
  'claudeApi.copied': '已复制！',
  'claudeApi.copyToClipboard': '复制到剪贴板',
  'claudeApi.versionLabel': '版本: {version}',
  'claudeApi.backToList': '返回列表',
  'claudeApi.test': '测试',
  'claudeApi.tab.code': '代码',
  'claudeApi.skillLabel': 'Skill:',
  'claudeApi.uploadedByStudio': '（由 cc-wf-studio 上传）',
  'claudeApi.loadingSkillDetails': '正在加载 Skill 详情...',
  'claudeApi.model': '模型',
  'claudeApi.language': '语言',
  'claudeApi.languagePlaceholder': '例如: Chinese, English',
  'claudeApi.additionalSkills': '附加 Skill',
  'claudeApi.requiredBadge': '必需',
  'claudeApi.notYetUploaded': '尚未上传: {names}',
  'claudeApi.sendMessageToTest': '发送消息以测试该 Skill。',
  'claudeApi.uploadSkillsFirst': '请先上传以下 Skill: {names}',
  'claudeApi.requiredSkillsNotSelected': '未选择必需的附加 Skill',
  'claudeApi.mcpUrlsMissing': '未填写 MCP 服务器的 URL 或 Token: {names}',
  'claudeApi.resetConversationMessage': '聊天记录将被清除。是否继续？',
  'claudeApi.reset': '重置',
  'claudeApi.totalUsage': '总用量:',
  'claudeApi.totalTokensTooltip': '合计: {total} 个 token',
  'claudeApi.requiredSkillsMissingTooltip': '缺少必需的附加 Skill',
  'claudeApi.enterMcpUrlsFirst': '请先输入 MCP 服务器 URL',
  'claudeApi.sendMessage': '发送消息',
  'claudeApi.executionFailed': '执行失败',
  'claudeApi.deleteSkill.title': '删除 Skill',
  'claudeApi.deleteSkill.message': '确定要删除“{title}”吗？此操作无法撤销。',
  'claudeApi.deleting': '正在删除...',
  'claudeApi.deleteSkillFailed': '删除 Skill 失败',
  'claudeApi.defaultTestPrompt': '请执行该工作流。',
  'claudeApi.mcpServerUrls': 'MCP 服务器 URL',
  'claudeApi.remoteMcpOnly': 'Claude API 仅支持远程 HTTP MCP 服务器（type: url）。',
  'claudeApi.dontKnowUrl': '不知道 URL？',
  'claudeApi.needAuthentication': '需要身份验证？',
  'claudeApi.enterBearerToken': '输入 Bearer Token',
  'claudeApi.pastePatOrApiKey': '粘贴 PAT 或 API 密钥。',
  'claudeApi.or': '或',
  'claudeApi.obtainTokenViaOauth': '通过 OAuth 获取令牌',
  'claudeApi.useInspector.before': '使用',
  'claudeApi.useInspector.after': '完成 OAuth 流程:',
  'claudeApi.authIntro.before': '对于需要 OAuth 的 MCP 服务器，请通过',
  'claudeApi.authIntro.after': '获取 access_token:',
  'claudeApi.authStep.run': '运行:',
  'claudeApi.authStep.sidebar': '在侧边栏中选择 transport type，输入服务器 URL，然后点击 "Connect"',
  'claudeApi.authStep.mainArea': '在主区域中点击 "Open Auth Settings" → "Quick OAuth Flow"',
  'claudeApi.authStep.copyToken.before':
    '完成授权后，展开 OAuth Flow Progress 底部的 "Access Token"，从 JSON 中复制',
  ...
  'commentary.options.title': 'Commentary AI 选项',
  'commentary.options.provider': '提供商',
  'commentary.options.language': '语言',
  'commentary.options.model': '模型',
  'commentary.options.noModels': '没有可用的模型',
