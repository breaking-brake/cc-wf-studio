...
export const jaWebviewTranslations: WebviewTranslationKeys = {
  ...
  'overview.zoomIn': 'ズームイン',
  'overview.zoomOut': 'ズームアウト',
  'overview.fitView': '全体を表示',
  'overview.followActive.on': 'アクティブノードを追従: オン',
  'overview.followActive.off': 'アクティブノードを追従: オフ',
  'overview.layout.td': 'レイアウト: 上から下（クリックで左から右に切り替え）',
  'overview.layout.lr': 'レイアウト: 左から右（クリックで上から下に切り替え）',
  'overview.resizePanels': 'ビューパネルのサイズを変更',
  'overview.editNodeLink': 'Editモードに切り替えてこのノードへ移動',
  ...
  'workflowTour.title': 'ワークフローツアー',
  'workflowTour.start': 'ワークフローツアーを開始',
  'workflowTour.start.tooltip': 'ワークフローツアーを開始（{count}ステップ）',
  'workflowTour.generate': 'ワークフローツアーを生成',
  'workflowTour.generate.tooltip': 'ワークフローツアーを生成',
  'workflowTour.noTour': 'このワークフローにはガイドツアーがありません。',
  'workflowTour.noTourLabel': 'ワークフローツアーなし',
  'workflowTour.prev': '前へ',
  'workflowTour.end': 'ワークフローツアーを終了',
  'workflowTour.regenerate': '再生成',
  'workflowTour.regenerate.tooltip': 'AIエージェントでこのツアーを再生成',
  'workflowTour.regenerate.aria': 'ワークフローツアーを再生成',
  'workflowTour.popover.agent': 'エージェント',
  'workflowTour.popover.emptyHeading': 'ワークフローツアーがまだありません',
  'workflowTour.popover.emptyDescription':
    'AIエージェントでこのワークフローのステップバイステップツアーを生成します。',
  'workflowTour.popover.generating': '生成中…',
  'workflowTour.popover.regenerateHeading': 'ワークフローツアーを再生成',
  'workflowTour.popover.regenerateDescription': '現在のツアーを新しく生成したものに置き換えます。',
  'workflowTour.popover.regenerateButton': 'ツアーを再生成',
  ...
  'contextMenu.groupSelection': 'グループ化',
  ...
  'shortcuts.tooltip': 'キーボードショートカット',
  ...
  'shortcuts.cut': '選択範囲を切り取り',
  'shortcuts.paste': '貼り付け',
  'shortcuts.duplicate': '選択範囲を複製',
  'shortcuts.group': '選択範囲をグループ化',
  'shortcuts.ungroup': '選択グループを解除',
  'shortcuts.nudge': '選択ノードを移動',
  'shortcuts.nudgeLarge': '選択ノードを大きく移動',
  ...
  'shortcuts.toggleInteraction': 'パン／範囲選択を一時的に切り替え',
  'shortcuts.gesture.arrowKeys': '矢印キー',
  'shortcuts.gesture.rightClick': '右クリック',
  'shortcuts.gesture.dragToCanvas': 'エッジをキャンバスへドラッグ',
  'shortcuts.gesture.drag': 'ドラッグ',
  ...
  'askUserQuestion.field.options': '選択肢（{count}/4）',
  'askUserQuestion.field.options.item': '選択肢 {number}',
  'askUserQuestion.field.options.add': '+ 選択肢を追加',
  'branch.field.branchType': '分岐タイプ',
  'branch.field.branchType.option.conditional': '条件分岐（2分岐）',
  'branch.field.branchType.option.switch': 'スイッチ（多分岐）',
  'branch.field.branches': '分岐（{count}）',
  'branch.field.branches.item': '分岐 {number}',
  'branch.field.branches.add': '+ 分岐を追加',
  'ifElse.field.evaluationTarget': '評価対象',
  'ifElse.field.evaluationTarget.placeholder': '例：前のステップの実行結果',
  'ifElse.field.evaluationTarget.help': '分岐条件で評価する対象を自然言語で記述',
  'ifElse.field.branches': '分岐（{count}）',
  'ifElse.field.branches.item': '分岐 {number}',
  'switch.field.evaluationTarget': '評価対象',
  'switch.field.evaluationTarget.placeholder': '例：前のステップの実行結果',
  'switch.field.evaluationTarget.help': '分岐条件で評価する対象を自然言語で記述',
  'switch.field.branches': '分岐（{count}）',
  'switch.field.branches.item': '分岐 {number}',
  'switch.field.branches.add': '+ 分岐を追加',
  ...
  'subAgent.field.agentType': 'エージェントタイプ',
  'subAgent.field.model': 'モデル',
  'subAgent.field.tools': 'ツール（カンマ区切り）',
  'subAgent.field.memory': 'メモリ',
  'subAgent.field.color': '色',
  'subAgent.field.builtInType': 'ビルトインタイプ',
  ...
  'claudeApi.title.apiTest': 'API テスト',
  'claudeApi.title.apiKeyRequired': 'API キーが必要です',
  'claudeApi.checkingApiKey': 'API キーを確認中...',
  'claudeApi.enterApiKeyIntro':
    'Anthropic API キーを入力すると、Skill のデプロイと管理ができます。キーは VS Code のシークレットストレージに安全に保存されます。API キーは',
  'claudeApi.enterApiKeyIntro.linkLabel': 'こちら',
  'claudeApi.enterApiKeyIntro.after': 'から作成できます。',
  'claudeApi.apiKeyLabel': 'API キー',
  'claudeApi.apiKeyInvalidPrefix': 'API キーは「sk-ant-」で始まる必要があります',
  'claudeApi.apiKeySaveFailed': 'API キーの保存に失敗しました',
  'claudeApi.deleteApiKey': 'API キーを削除',
  'claudeApi.deleteApiKeyConfirm':
    'API キーを削除しますか？続行するには新しいキーの入力が必要になります。',
  'claudeApi.apiKeyDeleted': 'API キーを削除しました。',
  'claudeApi.saveAndContinue': '保存して続行',
  'claudeApi.loadingSkills': 'Skill を読み込み中...',
  'claudeApi.loadSkillsFailed': 'Skill の読み込みに失敗しました',
  'claudeApi.uploadedSkills': 'アップロード済みの Skill',
  'claudeApi.noSkillsFound':
    'カスタム Skill が見つかりません。最初のワークフローをアップロードしましょう！',
  'claudeApi.delete': '削除',
  'claudeApi.changeApiKey': 'API キーを変更',
  'claudeApi.uploadNew': '新規アップロード',
  'claudeApi.workflowToUpload': 'アップロードするワークフロー:',
  'claudeApi.untitled': '無題',
  'claudeApi.mcpNodesWarning.title': 'このワークフローには MCP Tool ノードが含まれています',
  'claudeApi.mcpNodesWarning.body':
    'Claude API はリモート HTTP MCP サーバー（type: url）のみをサポートします。ローカルの stdio サーバーは使用できません。アップロード後、Sample Code / Test 画面でサーバー URL の設定が必要です。',
  'claudeApi.dependentSkills.title': 'このワークフローは他の Skill に依存しています',
  'claudeApi.dependentSkills.note':
    'この Skill が正しく動作するには、依存する Skill を先にアップロードする必要があります。今アップロードして、依存関係を後から追加することもできます。',
  'claudeApi.dependentSkillsLabel': '依存 Skill:',
  'claudeApi.notUploadedSuffix': '（未アップロード）',
  'claudeApi.upload': 'アップロード',
  'claudeApi.uploadAllMissing': '不足分をすべてアップロード',
  'claudeApi.retry': '再試行',
  'claudeApi.sameNameNote':
    '同じ名前の Skill が既に存在する場合は、新しいバージョンが作成されます。',
  'claudeApi.back': '戻る',
  'claudeApi.uploadingToApi': 'Claude API にアップロード中...',
  'claudeApi.uploadFailed': 'アップロードに失敗しました',
  'claudeApi.newVersionCreated': '新しいバージョンを作成しました！',
  'claudeApi.skillUploaded': 'Skill をアップロードしました！',
  'claudeApi.skillIdLabel': 'Skill ID:',
  'claudeApi.copy': 'コピー',
  'claudeApi.copied': 'コピーしました！',
  'claudeApi.copyToClipboard': 'クリップボードにコピー',
  'claudeApi.versionLabel': 'バージョン: {version}',
  'claudeApi.backToList': '一覧に戻る',
  'claudeApi.test': 'テスト',
  'claudeApi.tab.code': 'コード',
  'claudeApi.skillLabel': 'Skill:',
  'claudeApi.uploadedByStudio': '（cc-wf-studio からアップロード）',
  'claudeApi.loadingSkillDetails': 'Skill の詳細を読み込み中...',
  'claudeApi.model': 'モデル',
  'claudeApi.language': '言語',
  'claudeApi.languagePlaceholder': '例: Japanese, English',
  'claudeApi.additionalSkills': '追加 Skill',
  'claudeApi.requiredBadge': '必須',
  'claudeApi.notYetUploaded': '未アップロード: {names}',
  'claudeApi.sendMessageToTest': 'メッセージを送信して Skill をテストします。',
  'claudeApi.uploadSkillsFirst': '先に次の Skill をアップロードしてください: {names}',
  'claudeApi.requiredSkillsNotSelected': '必須の追加 Skill が選択されていません',
  'claudeApi.mcpUrlsMissing': 'MCP サーバーの URL または Token が未入力です: {names}',
  'claudeApi.resetConversationMessage': 'チャット履歴が消去されます。続行しますか？',
  'claudeApi.reset': 'リセット',
  'claudeApi.totalUsage': '合計使用量:',
  'claudeApi.totalTokensTooltip': '合計: {total} トークン',
  'claudeApi.requiredSkillsMissingTooltip': '必須の追加 Skill が不足しています',
  'claudeApi.enterMcpUrlsFirst': '先に MCP サーバーの URL を入力してください',
  'claudeApi.sendMessage': 'メッセージを送信',
  'claudeApi.executionFailed': '実行に失敗しました',
  'claudeApi.deleteSkill.title': 'Skill を削除',
  'claudeApi.deleteSkill.message': '「{title}」を削除しますか？この操作は元に戻せません。',
  'claudeApi.deleting': '削除中...',
  'claudeApi.deleteSkillFailed': 'Skill の削除に失敗しました',
  'claudeApi.defaultTestPrompt': 'ワークフローを実行してください。',
  'claudeApi.mcpServerUrls': 'MCP サーバー URL',
  'claudeApi.remoteMcpOnly':
    'Claude API はリモート HTTP MCP サーバー（type: url）のみをサポートします。',
  'claudeApi.dontKnowUrl': 'URL がわからない場合',
  'claudeApi.needAuthentication': '認証が必要な場合',
  'claudeApi.enterBearerToken': 'Bearer Token を入力',
  'claudeApi.pastePatOrApiKey': 'PAT または API キーを貼り付けます。',
  'claudeApi.or': 'または',
  'claudeApi.obtainTokenViaOauth': 'OAuth でトークンを取得',
  'claudeApi.useInspector.before': 'OAuth フローを完了するには',
  'claudeApi.useInspector.after': 'を使用します:',
  'claudeApi.authIntro.before': 'OAuth が必要な MCP サーバーでは、access_token を',
  'claudeApi.authIntro.after': 'で取得します:',
  'claudeApi.authStep.run': '実行:',
  'claudeApi.authStep.sidebar':
    'サイドバーで transport type を選択し、サーバー URL を入力して「Connect」をクリック',
  'claudeApi.authStep.mainArea':
    'メインエリアで「Open Auth Settings」→「Quick OAuth Flow」をクリック',
  'claudeApi.authStep.copyToken.before':
    '認可を完了し、OAuth Flow Progress 下部の「Access Token」を展開して、JSON から',
  'claudeApi.authStep.copyToken.after': 'の値をコピー',
