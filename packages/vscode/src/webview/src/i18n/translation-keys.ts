...
export interface WebviewTranslationKeys {
  ...
  'contextMenu.ungroupSelection': string;
  ...
  'claudeApi.title.apiTest': string;
  'claudeApi.title.apiKeyRequired': string;
  'claudeApi.checkingApiKey': string;
  'claudeApi.enterApiKeyIntro': string;
  'claudeApi.enterApiKeyIntro.linkLabel': string;
  'claudeApi.enterApiKeyIntro.after': string;
  'claudeApi.apiKeyLabel': string;
  'claudeApi.apiKeyInvalidPrefix': string;
  'claudeApi.apiKeySaveFailed': string;
  'claudeApi.deleteApiKey': string;
  'claudeApi.deleteApiKeyConfirm': string;
  'claudeApi.apiKeyDeleted': string;
  'claudeApi.saveAndContinue': string;
  'claudeApi.loadingSkills': string;
  'claudeApi.loadSkillsFailed': string;
  'claudeApi.uploadedSkills': string;
  'claudeApi.noSkillsFound': string;
  'claudeApi.delete': string;
  'claudeApi.changeApiKey': string;
  'claudeApi.uploadNew': string;
  'claudeApi.workflowToUpload': string;
  'claudeApi.untitled': string;
  'claudeApi.mcpNodesWarning.title': string;
  'claudeApi.mcpNodesWarning.body': string;
  'claudeApi.dependentSkills.title': string;
  'claudeApi.dependentSkills.note': string;
  'claudeApi.dependentSkillsLabel': string;
  'claudeApi.notUploadedSuffix': string;
  'claudeApi.upload': string;
  'claudeApi.uploadAllMissing': string;
  'claudeApi.retry': string;
  'claudeApi.sameNameNote': string;
  'claudeApi.back': string;
  'claudeApi.uploadingToApi': string;
  'claudeApi.uploadFailed': string;
  'claudeApi.newVersionCreated': string;
  'claudeApi.skillUploaded': string;
  'claudeApi.skillIdLabel': string;
  'claudeApi.copy': string;
  'claudeApi.copied': string;
  'claudeApi.copyToClipboard': string;
  'claudeApi.versionLabel': string;
  'claudeApi.backToList': string;
  'claudeApi.test': string;
  'claudeApi.tab.code': string;
  'claudeApi.skillLabel': string;
  'claudeApi.uploadedByStudio': string;
  'claudeApi.loadingSkillDetails': string;
  'claudeApi.model': string;
  'claudeApi.language': string;
  'claudeApi.languagePlaceholder': string;
  'claudeApi.additionalSkills': string;
  'claudeApi.requiredBadge': string;
  'claudeApi.notYetUploaded': string;
  'claudeApi.sendMessageToTest': string;
  'claudeApi.uploadSkillsFirst': string;
  'claudeApi.requiredSkillsNotSelected': string;
  'claudeApi.mcpUrlsMissing': string;
  'claudeApi.resetConversationMessage': string;
  'claudeApi.reset': string;
  'claudeApi.totalUsage': string;
  'claudeApi.totalTokensTooltip': string;
  'claudeApi.requiredSkillsMissingTooltip': string;
  'claudeApi.enterMcpUrlsFirst': string;
  'claudeApi.sendMessage': string;
  'claudeApi.executionFailed': string;
  'claudeApi.deleteSkill.title': string;
  'claudeApi.deleteSkill.message': string;
  'claudeApi.deleting': string;
  'claudeApi.deleteSkillFailed': string;
  'claudeApi.defaultTestPrompt': string;
  'claudeApi.mcpServerUrls': string;
  'claudeApi.remoteMcpOnly': string;
  'claudeApi.dontKnowUrl': string;
  'claudeApi.needAuthentication': string;
  'claudeApi.enterBearerToken': string;
  'claudeApi.pastePatOrApiKey': string;
  'claudeApi.or': string;
  'claudeApi.obtainTokenViaOauth': string;
  'claudeApi.useInspector.before': string;
  'claudeApi.useInspector.after': string;
  'claudeApi.authIntro.before': string;
  'claudeApi.authIntro.after': string;
  'claudeApi.authStep.run': string;
  'claudeApi.authStep.sidebar': string;
  'claudeApi.authStep.mainArea': string;
  'claudeApi.authStep.copyToken.before': string;
  'claudeApi.authStep.copyToken.after': string;
